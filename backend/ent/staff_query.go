...
func (sq *StaffQuery) QueryPredicament() *PredicamentQuery {
...
func (sq *StaffQuery) WithPredicament(opts ...func(*PredicamentQuery)) *StaffQuery {
	query := &PredicamentQuery{config: sq.config}
...
func (sq *StaffQuery) sqlAll(ctx context.Context) ([]*Staff, error) {
	...
	if query := sq.withPredicament; query != nil {
		...
		query.Where(predicate.Predicament(func(s *sql.Selector) {
			s.Where(sql.InValues(staff.PredicamentColumn, fks...))
		}))
