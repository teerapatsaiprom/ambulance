...
func (e StaffEdges) PredicamentOrErr() ([]*Predicament, error) {
	if e.loadedTypes[0] {
...
// QueryPredicament queries the predicament edge of the Staff.
func (s *Staff) QueryPredicament() *PredicamentQuery {
	return (&StaffClient{config: s.config}).QueryPredicament(s)
}
