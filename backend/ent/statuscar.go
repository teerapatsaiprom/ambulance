...
func (e StatuscarEdges) PredicamentOrErr() ([]*Predicament, error) {
	if e.loadedTypes[0] {
...
// QueryPredicament queries the predicament edge of the Statuscar.
func (s *Statuscar) QueryPredicament() *PredicamentQuery {
	return (&StatuscarClient{config: s.config}).QueryPredicament(s)
}
