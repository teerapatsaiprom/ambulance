...
func (e CarEdges) PredicamentOrErr() ([]*Predicament, error) {
	if e.loadedTypes[0] {
...
// QueryPredicament queries the predicament edge of the Car.
func (c *Car) QueryPredicament() *PredicamentQuery {
	return (&CarClient{config: c.config}).QueryPredicament(c)
}
