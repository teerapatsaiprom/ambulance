...
var (
	...
	PredicamentsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:  "predicaments_cars_predicament",
			...
			{
				Symbol:  "predicaments_staffs_predicament",
			...
			{
				Symbol:  "predicaments_statuscars_predicament",
			...
			{
				Symbol:  "predicaments_users_predicament",
