...
// QueryPredicament queries the predicament edge of a Car.
func (c *CarClient) QueryPredicament(ca *Car) *PredicamentQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, car.PredicamentTable, car.PredicamentColumn),
		)
...
// QueryPredicament queries the predicament edge of a Staff.
func (c *StaffClient) QueryPredicament(s *Staff) *PredicamentQuery {
	query := &PredicamentQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := s.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(predicament.Table, predicament.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, staff.PredicamentTable, staff.PredicamentColumn),
		)
...
// QueryPredicament queries the predicament edge of a Statuscar.
func (c *StatuscarClient) QueryPredicament(s *Statuscar) *PredicamentQuery {
	query := &PredicamentQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := s.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(predicament.Table, predicament.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, statuscar.PredicamentTable, statuscar.PredicamentColumn),
		)
		fromV = sqlgraph.Neighbors(s.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryPredicament queries the predicament edge of a User.
func (c *UserClient) QueryPredicament(u *User) *PredicamentQuery {
	query := &PredicamentQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(predicament.Table, predicament.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, user.PredicamentTable, user.PredicamentColumn),
		)
