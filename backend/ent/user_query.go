...
func (uq *UserQuery) QueryPredicament() *PredicamentQuery {
...
func (uq *UserQuery) WithPredicament(opts ...func(*PredicamentQuery)) *UserQuery {
	query := &PredicamentQuery{config: uq.config}
	for _, opt := range opts {
		opt(query)
	}
	uq.withPredicament = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withPredicament; query != nil {
		...
		query.Where(predicate.Predicament(func(s *sql.Selector) {
			s.Where(sql.InValues(user.PredicamentColumn, fks...))
		}))
