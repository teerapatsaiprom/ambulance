...
type CarMutation struct {
	...
	predicament        map[int]struct{}
	removedpredicament map[int]struct{}
	done               bool
...
func (m *CarMutation) AddPredicamentIDs(ids ...int) {
	if m.predicament == nil {
		m.predicament = make(map[int]struct{})
	}
	for i := range ids {
		m.predicament[ids[i]] = struct{}{}
	}
}

// RemovePredicamentIDs removes the predicament edge to Predicament by ids.
func (m *CarMutation) RemovePredicamentIDs(ids ...int) {
	if m.removedpredicament == nil {
		m.removedpredicament = make(map[int]struct{})
	}
	for i := range ids {
		m.removedpredicament[ids[i]] = struct{}{}
	}
}

// RemovedPredicament returns the removed ids of predicament.
func (m *CarMutation) RemovedPredicamentIDs() (ids []int) {
	for id := range m.removedpredicament {
		ids = append(ids, id)
	}
	return
}

// PredicamentIDs returns the predicament ids in the mutation.
func (m *CarMutation) PredicamentIDs() (ids []int) {
	for id := range m.predicament {
		ids = append(ids, id)
	}
	return
}

// ResetPredicament reset all changes of the "predicament" edge.
func (m *CarMutation) ResetPredicament() {
	m.predicament = nil
	m.removedpredicament = nil
}
...
func (m *CarMutation) AddedEdges() []string {
	...
	if m.predicament != nil {
		edges = append(edges, car.EdgePredicament)
	}
	return edges
}
...
func (m *CarMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case car.EdgePredicament:
		ids := make([]ent.Value, 0, len(m.predicament))
		for id := range m.predicament {
			ids = append(ids, id)
		}
		return ids
...
func (m *CarMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case car.EdgePredicament:
		ids := make([]ent.Value, 0, len(m.removedpredicament))
		for id := range m.removedpredicament {
			ids = append(ids, id)
		}
		return ids
...
// AddPredicamentIDs adds the predicament edge to Predicament by ids.
func (m *StaffMutation) AddPredicamentIDs(ids ...int) {
	if m.predicament == nil {
		m.predicament = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovePredicamentIDs removes the predicament edge to Predicament by ids.
func (m *StaffMutation) RemovePredicamentIDs(ids ...int) {
	if m.removedpredicament == nil {
		m.removedpredicament = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovedPredicament returns the removed ids of predicament.
func (m *StaffMutation) RemovedPredicamentIDs() (ids []int) {
	for id := range m.removedpredicament {
		ids = append(ids, id)
	}
	return
...
// PredicamentIDs returns the predicament ids in the mutation.
func (m *StaffMutation) PredicamentIDs() (ids []int) {
	for id := range m.predicament {
		ids = append(ids, id)
	}
	return
...
// ResetPredicament reset all changes of the "predicament" edge.
func (m *StaffMutation) ResetPredicament() {
	m.predicament = nil
	m.removedpredicament = nil
}
...
func (m *StaffMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.predicament != nil {
		edges = append(edges, staff.EdgePredicament)
	}
	return edges
}
...
// AddPredicamentIDs adds the predicament edge to Predicament by ids.
func (m *StatuscarMutation) AddPredicamentIDs(ids ...int) {
	if m.predicament == nil {
		m.predicament = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovePredicamentIDs removes the predicament edge to Predicament by ids.
func (m *StatuscarMutation) RemovePredicamentIDs(ids ...int) {
	if m.removedpredicament == nil {
		m.removedpredicament = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovedPredicament returns the removed ids of predicament.
func (m *StatuscarMutation) RemovedPredicamentIDs() (ids []int) {
	for id := range m.removedpredicament {
		ids = append(ids, id)
	}
	return
...
// PredicamentIDs returns the predicament ids in the mutation.
func (m *StatuscarMutation) PredicamentIDs() (ids []int) {
	for id := range m.predicament {
		ids = append(ids, id)
	}
	return
...
// ResetPredicament reset all changes of the "predicament" edge.
func (m *StatuscarMutation) ResetPredicament() {
	m.predicament = nil
	m.removedpredicament = nil
}
...
func (m *StatuscarMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.predicament != nil {
		edges = append(edges, statuscar.EdgePredicament)
	}
	return edges
}
...
func (m *StatuscarMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case statuscar.EdgePredicament:
		ids := make([]ent.Value, 0, len(m.predicament))
		for id := range m.predicament {
			ids = append(ids, id)
		}
...
// AddPredicamentIDs adds the predicament edge to Predicament by ids.
func (m *UserMutation) AddPredicamentIDs(ids ...int) {
	if m.predicament == nil {
		m.predicament = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovePredicamentIDs removes the predicament edge to Predicament by ids.
func (m *UserMutation) RemovePredicamentIDs(ids ...int) {
	if m.removedpredicament == nil {
		m.removedpredicament = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovedPredicament returns the removed ids of predicament.
func (m *UserMutation) RemovedPredicamentIDs() (ids []int) {
	for id := range m.removedpredicament {
		ids = append(ids, id)
	}
	return
...
// PredicamentIDs returns the predicament ids in the mutation.
func (m *UserMutation) PredicamentIDs() (ids []int) {
	for id := range m.predicament {
		ids = append(ids, id)
	}
	return
...
// ResetPredicament reset all changes of the "predicament" edge.
func (m *UserMutation) ResetPredicament() {
	m.predicament = nil
	m.removedpredicament = nil
}
...
func (m *UserMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.predicament != nil {
		edges = append(edges, user.EdgePredicament)
	}
	return edges
}
