...
func (su *StaffUpdate) AddPredicamentIDs(ids ...int) *StaffUpdate {
	su.mutation.AddPredicamentIDs(ids...)
	return su
}

// AddPredicament adds the predicament edges to Predicament.
func (su *StaffUpdate) AddPredicament(p ...*Predicament) *StaffUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
func (su *StaffUpdate) RemovePredicamentIDs(ids ...int) *StaffUpdate {
	su.mutation.RemovePredicamentIDs(ids...)
	return su
}

// RemovePredicament removes predicament edges to Predicament.
func (su *StaffUpdate) RemovePredicament(p ...*Predicament) *StaffUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
// AddPredicamentIDs adds the predicament edge to Predicament by ids.
func (suo *StaffUpdateOne) AddPredicamentIDs(ids ...int) *StaffUpdateOne {
	suo.mutation.AddPredicamentIDs(ids...)
	return suo
}

// AddPredicament adds the predicament edges to Predicament.
func (suo *StaffUpdateOne) AddPredicament(p ...*Predicament) *StaffUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
// RemovePredicamentIDs removes the predicament edge to Predicament by ids.
func (suo *StaffUpdateOne) RemovePredicamentIDs(ids ...int) *StaffUpdateOne {
	suo.mutation.RemovePredicamentIDs(ids...)
	return suo
}

// RemovePredicament removes predicament edges to Predicament.
func (suo *StaffUpdateOne) RemovePredicament(p ...*Predicament) *StaffUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
